...
const Blog = ({ author,date,avatar,srcImage,title,description,amountOfLikes,comments }) => {
    ...
    const handleComment = () => {
      setMyComment([...myComment,{ author : "Selam 4", text : value ,  date : "23 Temmuz 2021", avatar : "/svg/logosoy-2.svg" }])
    }
      ...
      <Grid container item xs={12} className={classes.gridSpacing}>
        <Card className={classes.mainSide}>
          ...
          >
            ...
            <IconButton className={classes.linkingBtn}>
              <ArrowForwardIosIcon />
            </IconButton>
          </CardActions>
